  ...
  $scope.notifications = $firebaseArray(myNotificationRef);
	...
	$scope.reviewTransaction = function (notification){
		...
		if (auth.getUid() === notification.createdby){
			...
			// push to firebase on the createdbyUid
